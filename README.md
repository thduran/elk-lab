...
- [☸️ Implementação 2: Kubernetes (Cloud Native)](#-implementação-2-kubernetes-cloud-native)
...
- [Fluxo de dados de cada arquivo](#fluxo-de-dados-de-cada-arquivo)
...
## Fluxo de dados de cada arquivo
